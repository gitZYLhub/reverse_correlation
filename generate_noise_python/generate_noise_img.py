...
for i in range(num_loops):
    patches = generatePatches(img_size, nscale=4)
    ...
    # np.save(f'ampli_exp_{i}.npy', store_amplitude)
    ...
    plt.savefig(f'images_2cycle_4scale/image_exp_{i}.png', dpi= ppi)
    plt.close()

np.save('images_2cycle_4scale/all_amplitude.npy', all_ampli)
